---
layout: post
title: Learning task-agnostic triggers for API-based LLMs
description: Bachelor's Thesis Project
---



The objective of this project is to adapt white-box attacks, which assume access to model parameters for computing gradients of an adversarial loss, to API-based LLMs. 
